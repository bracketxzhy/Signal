...
\caption{Front novel view with directional color}
\end{figure}
\end{center}
...
\begin{figure}
\centering
\imageorplaceholder{figures/000060_overlay.png}{0.8\textheight}
\caption{Back novel view with directional color}
\end{figure}
\end{center}
\end{columns}
\end{frame}
